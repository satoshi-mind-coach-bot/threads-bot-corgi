...
## 生成ルール（厳守）
- 一人称は「ぼく」または一人称なし。「俺」「僕」は絶対禁止
- ハッシュタグは絶対付けない
- 絵文字は必ず1〜3個使うこと（🐾✨🌸💕🌟🍀🌈☀️🌙💪🎉🫶 などかわいい系）
- 投稿の最後か途中に必ず絵文字を入れる
- パターン16種をなるべく分散させる
- テーマ5カテゴリをバランスよく使う
- 1投稿100〜250文字
...
## time_slot の定義（厳守）
- "朝": テーマが「朝の名言」の投稿は **必ず "朝"**。「おはよう」「朝」「起きた」「今日も」など朝を連想させる表現が含まれる投稿も "朝"
- "昼": 「こんにちは」「昼」「午後」など昼を連想させる表現が含まれる投稿
- "夜": 「こんばんは」「夜」「今夜」「夜中」「おやすみ」など夜を連想させる表現が含まれる投稿
- "フリー": 時間帯に関係なく読める投稿（テーマが「朝の名言」以外で、時間帯表現がない場合のみ）
- **テーマ「朝の名言」の投稿を "フリー" にすることは絶対禁止**
